...
export default function ProfileStatusModal({
  ...
  return (
    <div className="fixed inset-0 w-full h-screen z-50 flex items-center justify-center bg-black/60">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              >
                <input
                  ...
                  className="sr-only"
                />
                <CheckCircle className={`h-5 w-5 ${status === 'approved' ? 'text-green-400' : 'text-zinc-500'}`} />
                <div>
              ...
              >
                <input
                  ...
                  className="sr-only"
                />
                <AlertCircle className={`h-5 w-5 ${status === 'changes_requested' ? 'text-orange-400' : 'text-zinc-500'}`} />
                <div>
              ...
              >
                <input
                  ...
                  className="sr-only"
                />
                <XCircle className={`h-5 w-5 ${status === 'rejected' ? 'text-red-400' : 'text-zinc-500'}`} />
                <div>
