		...
		return (
			<div className="space-y-8 mt-14">
				...
				{applications.length > 0 ? (
					...
					<div className="rounded-md max-h-[40rem] overflow-y-auto">
						...
						<div className="space-y-3">
							{applications.map(app => (
								<div
									key={app.id}
									className="flex items-center justify-between p-4 rounded-md border border-slate-200 bg-white hover:bg-slate-100 transition-colors cursor-pointer"
					...
					<div className="text-slate-500 text-center">Nenhuma candidatura encontrada.</div>
				)}
			</div>
		);
}
