...
import { ChevronRight, Users, ArrowRight, Building2, Search, Zap, MapPin, Clock, Monitor, Calendar, Filter, X } from 'lucide-react';
    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-white via-zinc-100 to-white">
      ...
      <section className="pt-18 lg:pt-28 pb-20 px-4 bg-gradient-to-r from-blue-800 to-blue-950">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-6">
            <h1 className="text-5xl 2xl:text-6xl font-bold text-slate-100 mb-3 leading-tight quicksand gap-x-6 flex flex-wrap w-[70%] justify-center mx-auto">
              <SplitText
                text="Conectamos"
                className="text-3xl lg:text-6xl text-yellow-400 mb-2"
                delay={30}
                duration={1}
              />
              <SplitText
                text="Talentos"
                className="text-3xl lg:text-6xl text-slate-200 mb-2"
                delay={30}
                duration={1}
              />
              <SplitText
            ...
            <p className="animate-fade-up animate-delay-[300ms] text-lg text-slate-200 max-w-4xl mx-auto leading-relaxed">
              Uma plataforma inovadora que revoluciona a forma como empresas e profissionais se conectam, 
            </p>
            <p className="animate-fade-up animate-delay-[600ms] text-lg text-slate-200 max-w-4xl mx-auto leading-relaxed">
